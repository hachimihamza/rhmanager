    ...
    <body>
        ...
        <div class="row">
            <div class="col-md-offset-3 col-md-6">
                <div class="well">
                    <h4 class="text-center text-uppercase">Ajout Employé</h4>

                    <form class="form-horizontal" action="ajouterEmploye.jsp" method="post">
                        <div class="form-group">
                            <label for="cin_employe">CIN Employe</label>
                            <input type="text" class="form-control" name="cin_employe" required>
                        </div>
                        <div class="form-group">
                            <label for="nom_employe">Nom</label>
                            <input type="text" class="form-control" name="nom_employe">
                        </div>
                        <div class="form-group">
                            <label for="prenom_employe">Prénom</label>
                            <input type="text" class="form-control" name="prenom_employe">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="date_fin">Date Recrutement :</label>
                            <input type="date" class="form-control" name="date_recrutement" placeholder="aaaa-mm-jj">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <label><input type="radio" name="is_admin" value="0" checked>Non</label>
                        </div>
