    ...
    <body>
        ...
        <div class="row">
            <div class="col-md-offset-3 col-md-6">
                <div class="well">
                    <h4 class="text-center text-uppercase">Modification Chef Département</h4>
                    ...
                    <sql:query dataSource="${dataSource}" var="result">
                        select * from chef where cin_chef=?
                        <sql:param value="${param.cin_chef}"/>
                    </sql:query>
                    <c:forEach var="row" items="${result.rows}">
                        <form action="modifierChef.jsp" method="post">
                            <div class="form-group">
                                <label for="cin_chef">CIN</label>
                                <input type="text" class="form-control" name="cin_chef" value="${row.cin_chef}" readonly>
                            </div>
                            <div class="form-group">
                                <label for="nom chef">Nom</label>
                                <input type="text" class="form-control" name="nom_chef" value="${row.nom_chef}">
                            </div>
                            <div class="form-group">
                                <label for="prenom chef">Prénom</label>
                                <input type="text" class="form-control" name="prenom_chef" value="${row.prenom_chef}">
                            </div>
                            <div class="form-group">
