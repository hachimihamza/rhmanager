            ...
            <div class="row">
                <div class="col-sm-3 col-md-2 sidebar">
                    <ul class="nav nav-sidebar">
                        <li>
                            <a data-toggle="tab" href="#conges">Congés<span class="badge pull-right">
                                    <sql:query dataSource="${dataSource}" var="result">
                                        select count(*) as count
                                        from arret a, employe e
                                        where type_arret= ? and status_arret="Attente Validation Chef" and e.cin_employe= a.cin_employe and a.cin_employe in
                                        ( select cin_employe
                                        from employe
                                        where num_departement in
                                        ( select num_departement from departement where cin_chef = ? )
                                        );
                        ...
                        <li><a data-toggle="tab" href="#maladies">Maladies<span class="badge pull-right">
                                    <sql:query dataSource="${dataSource}" var="result">
                                        select count(*) as count
                                        from arret a, employe e
                                        where type_arret= ? and status_arret="Non justifie" and e.cin_employe= a.cin_employe and a.cin_employe in
                                        ( select cin_employe
                                        from employe
                                        where num_departement in
                                        ( select num_departement from departement where cin_chef = ? )
                        ...
                        <li><a data-toggle="tab" href="#autorisations">Autorisations<span class="badge pull-right">
                                    <sql:query dataSource="${dataSource}" var="result">
                                        select count(*) as count
                                        from arret a, employe e
                                        where type_arret= ? and status_arret="Attente Validation Chef" and e.cin_employe= a.cin_employe and a.cin_employe in
                                        ...
                                        <tr class="${row.status_arret}">
                                            ...
                                            <td>
                                                <form action="UpdateArret" method="post" style="display:inline-block">
                                                    <input type="text" name="is_drh" value="non" hidden="true">
                                                    ...
                                                    <input type="text" name="status_arret" value="Attente Validation DRH" hidden="true">
                                                ...
                                                <form action="UpdateArret" method="post" style="display:inline-block">
                                                    ...
                                                    <input type="text" name="cin_chef" value="${param.cin_chef}" hidden="true">
                                                    <input type="text" name="num_arret" value="${row.num_arret}" hidden="true">
                                                    <input type="text" name="status_arret" value="Refuse par Chef" hidden="true">
