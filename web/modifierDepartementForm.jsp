    ...
    <body>
        ...
        <div class="row">
            <div class="col-md-offset-3 col-md-6">
                <div class="well">
                    <h4 class="text-center text-uppercase">Modification Departement</h4>
                    ...
                    <sql:query dataSource="${dataSource}" var="result">
                        select * from departement where num_departement=?
                        <sql:param value="${param.num_departement}"/>
                    </sql:query>
                    <c:forEach var="row" items="${result.rows}">
                        <form action="modifierDepartement.jsp" method="post">
                            <div class="form-group">
                                <label for="num_departement">Num Departement</label>
                                <input type="text" class="form-control" name="num_departement" value="${row.num_departement}" readonly>
                            </div>
                            <div class="form-group">
                                <label for="designation_departement">Designation Departement</label>
                                <input type="text" class="form-control" name="designation_departement" value="${row.designation_departement}">
                            </div>
                            <div class="form-group">
                                <label for="cin_chef">CIN Chef</label>
                                <input type="text" class="form-control" name="cin_chef" value="${row.cin_chef}">
                            </div>
